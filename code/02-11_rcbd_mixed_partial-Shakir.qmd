...
rcbd_mix_mod <- lme4::lmer(yield_kgha ~ nrate_kgha*krate_kgha + #We specify the interaction of the fixed effects first
                           (1|rep), #Syntax for random effect "rep" i.e., block effect in this case #(1|location/rep) means reps/blocks are nested inside location. we specify the factor that has higher hierarchy, then the factor with lower hierarchy is specified afterwards
                           data = rcbd_dfw
                           )
