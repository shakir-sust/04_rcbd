...
set.seed(930) #we use "set.seed" for the sake of reproducibility so that the randomization does not shuffle each time we run this code chunk
...
ggplot(data = crd_layout,
  ...
  geom_text(aes(label = plotlabel), vjust = 0.5) +
  labs()
